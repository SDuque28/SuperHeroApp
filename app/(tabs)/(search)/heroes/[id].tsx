...
export default function HeroDetailScreen() {
  const { id, heroData } = useLocalSearchParams<{
    id: string;
    heroData?: string;
  }>();
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setError("Could not load hero. Check your connection.");
      } finally {
        setLoad(false);
      }
    })();
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ height: IMG_H }}>
          ...
          <View style={s.nameBlock}>
            ...
            {hero.biography["full-name"] &&
              hero.biography["full-name"] !== "-" && (
                <Text style={s.heroFullName}>
                  {hero.biography["full-name"]}
                </Text>
              )}
            <Text style={s.heroPublisher}>
        ...
        <View style={s.body}>
          ...
          {total > 0 && (
            <View style={s.totalRow}>
              ...
              <View style={s.totalTrack}>
                <View
                  style={[s.totalFill, { width: `${(total / 600) * 100}%` }]}
                />
              </View>
          ...
          <Section title="BIOGRAPHY" color="#0057FF">
            <InfoRow
              label="Full Name"
              value={hero.biography["full-name"]}
              accent="#0057FF"
            />
            <InfoRow
              label="Alter Egos"
              value={hero.biography["alter-egos"]}
              accent="#0057FF"
            />
            <InfoRow label="Aliases" value={aliases} accent="#0057FF" />
            <InfoRow
              label="Born"
          ...
          <Section title="APPEARANCE" color="#E8173D">
            ...
            <InfoRow
              label="Height"
              value={hero.appearance.height?.[1] ?? hero.appearance.height?.[0]}
              accent="#E8173D"
            />
            <InfoRow
              label="Weight"
              value={hero.appearance.weight?.[1] ?? hero.appearance.weight?.[0]}
              accent="#E8173D"
            />
            <InfoRow
              label="Eyes"
              value={hero.appearance["eye-color"]}
              accent="#E8173D"
            />
            <InfoRow
              label="Hair"
          ...
          {(hero.connections?.["group-affiliation"] ||
            ...
            <Section title="CONNECTIONS" color="#FFD600">
              ...
              <InfoRow
                label="Relatives"
                value={hero.connections.relatives}
                accent="#FFD600"
              />
            </Section>
          )}
